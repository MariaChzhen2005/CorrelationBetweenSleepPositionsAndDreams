...
public class screenShortVividity {
    ...
    public static void screenShortVividity (CSVParser parser) {
        ...
        System.out.println("SCREEN TIME: 1-4 HOURS - WAKING POSITIONS - VIVIDITY");
