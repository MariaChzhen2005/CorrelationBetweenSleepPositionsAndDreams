...
public class sleepLongBizarreness {
    ...
    public static void sleepLongBizarreness (CSVParser parser) {
        ...
        for (CSVRecord record : parser) {
            ...
            if (bizarre != 0 && (sleepAvgInt==6||sleepAvgInt==7||sleepAvgInt==8||sleepAvgInt==9||sleepAvgInt==10||sleepAvgInt==11||sleepAvgInt==12)) {
                vividities.add(bizarre);
                wakePoses.add(wakePosInt);
                if (backPoses.contains(wakePosInt)) {
                    countBackPoses+=1;
                    backVividAvg+=bizarre;
                }
                if (leftPoses.contains(wakePosInt)) {
                    countLeftPoses+=1;
                    leftVividAvg+=bizarre;
                }
                if (rightPoses.contains(wakePosInt)) {
                    countRightPoses+=1;
                    rightVividAvg+=bizarre;
                }
                if (stomachPoses.contains(wakePosInt)) {
                    countStomachPoses+=1;
                    stomachVividAvg+=bizarre;
                }
        ...
        System.out.println("SLEEP LENGTH: 6-12 HOURS - WAKING POSITIONS - BIZARRENESS");
