...
public class screenShortScariness {
    ...
    public static void screenShortScariness (CSVParser parser) {
        ...
        for (CSVRecord record : parser) {
            String vividity = record.get("scariness");
        ...
        System.out.println("SCREEN TIME: 1-4 HOURS - WAKING POSITIONS - SCARINESS");
