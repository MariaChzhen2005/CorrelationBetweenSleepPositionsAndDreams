...
public class sleepLongVividity {
    ...
    public static void sleepLongVividity (CSVParser parser) {
        ...
        for (CSVRecord record : parser) {
            ...
            if (vivid != 0 && (sleepAvgInt==6||sleepAvgInt==7||sleepAvgInt==8||sleepAvgInt==9||sleepAvgInt==10||sleepAvgInt==11||sleepAvgInt==12)) {
        ...
        System.out.println("SLEEP LENGTH: 6-12 HOURS - WAKING POSITIONS - VIVIDITY");
