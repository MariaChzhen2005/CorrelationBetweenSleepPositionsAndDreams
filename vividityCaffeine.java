...
// compare vividity and caffeine consumption

public class vividityCaffeine {
    ...
    public static void vividityYesCaffeine (CSVParser parser) {
        ...
        for (CSVRecord record : parser) {
            ...
            String caffeine = record.get("caffeine");
            int wakePosInt = Integer.parseInt(wakePos);
            int vivid = Integer.parseInt(vividity);
            int caffeInt = Integer.parseInt(caffeine);
            if (vivid != 0 && caffeInt == 1) {
        ...
        System.out.println("YES CAFFEINE - WAKING POSITIONS - VIVIDITY");
    ...
    public static void tester() {
        ...
        vividityYesCaffeine(parser);
        //vividityNoCaffeine(parser);
    }
}
