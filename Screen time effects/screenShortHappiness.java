...
public class screenShortHappiness {
    ...
    public static void screenShortHappiness (CSVParser parser) {
        ...
        for (CSVRecord record : parser) {
            String vividity = record.get("happiness");
            ...
            if (vivid != 0 && (screentimeInt == 1||screentimeInt==2||screentimeInt==3||screentimeInt==4)) {
        ...
        System.out.println("SCREEN TIME: 1-4 HOURS - WAKING POSITIONS - HAPPINESS");
