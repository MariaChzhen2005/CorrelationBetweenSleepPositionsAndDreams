...
public class menPositions {
    ...
    public static void menPositions (CSVParser parser) {
        ...
        System.out.println("AVERAGE EMOTIONAL PARAMETERS - MEN");
        System.out.println("The amount of men sleeping on the back is " + backPerc);
        System.out.println("The amount of men sleeping on the front is " + frontPerc);
        System.out.println("The amount of men sleeping on the left is " + leftPerc);
        System.out.println("The amount of men sleeping on the right is " + rightPerc);
