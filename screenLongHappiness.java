...
public class screenLongHappiness {
    ...
    public static void screenLongHappiness (CSVParser parser) {
        ...
        System.out.println("SCREEN TIME: 5-18 HOURS - WAKING POSITIONS - HAPPINESS");
