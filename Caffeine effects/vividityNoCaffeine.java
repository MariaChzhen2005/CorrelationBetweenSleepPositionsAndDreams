...
// yes caffeine is 1, no caffeine is 2
public class vividityNoCaffeine {
    ...
    public static void vividityNoCaffeine (CSVParser parser) {
        ...
        System.out.println("NO CAFFEINE - WAKING POSITIONS - VIVIDITY");
