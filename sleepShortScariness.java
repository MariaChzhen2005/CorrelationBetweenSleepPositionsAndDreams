...
public class sleepShortScariness {
    ...
    public static void sleepShortScariness (CSVParser parser) {
        ...
        for (CSVRecord record : parser) {
            ...
            if (scary != 0 && (sleepAvgInt == 1||sleepAvgInt==2||sleepAvgInt==3||sleepAvgInt==4||sleepAvgInt==5)) {
        ...
        System.out.println("SLEEP LENGTH: 1-5 HOURS - WAKING POSITIONS - SCARINESS");
